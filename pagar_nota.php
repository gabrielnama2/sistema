...
<html lang="pt-br">
	...
	<body>
		<div class="container">
			...
			?>
			<form method="POST" action="proc_pagar_nota.php">
				...
				<?php echo "Total: R$ " . $row_usuario['total'] . "<br><br>"; ?>

				<label>Valor a Pagar: </label>
				<input class="form-control form-control-sm" style="width: 25%" type="number" step="0.01" name="pagar" placeholder="1.0"><br>
